<nav class="navbar navbar-dark fixed-top bg-dark d-flex flex-md-nowrap sticky-top navbar-expand-md shadow px-5">
    <button class="btn btn-dark d-sm-block border border-secondary" type="button" id="sidebarCollapse"
